...
/// ```
// NOTE: macro_rules! macros cannot be exported from a proc-macro crate
// These need to be moved to a separate non-proc-macro crate or converted to procedural macros
/*
#[macro_export]
macro_rules! vmap {
    // Empty map
...
// Dummy module to attach the last doc comment that was left hanging
/// This module contains functionality related to value maps.
pub mod vmap_module {
    // Empty module to ensure documentation is properly attached
} 